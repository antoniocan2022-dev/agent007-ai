...
const checks: Array<[string, boolean]> = [
  ...
  ['Experiment attribution failure is not swallowed', outcome.includes('await recordExperimentPaymentAttribution(') && !outcome.includes('recordExperimentPaymentAttribution({') === false],
  ...
  ['Portfolio rules consume canonical operational decision type', rules.includes('PortfolioOperationalDecision') || rules.includes('PortfolioDecision')],
