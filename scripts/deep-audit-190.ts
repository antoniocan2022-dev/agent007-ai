...
const groups = {
  ...
  'real_*':          ['real-intelligence-tools.ts', 'real-integrations.ts', 'real-integrations-extended.ts', 'reality-action-mode.ts', 'reality-gate.ts'],
  ...
  'optimization_*':  ['optimization-tools.ts'],
