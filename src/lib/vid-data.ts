 ...
 *
 * Every member's `tools` array lists REAL registered tool names (verified
 * in TOOL_REGISTRY at src/lib/tools.ts). The `source` field documents where
 * the implementation lives (file path or TOOL_REGISTRY entry).
 * No fake names — every tool name can be dispatched via dispatchTool().
 *
...
export const VID_MEMBERS: VidMember[] = [
  {
    ...
    tools: [
      { name: 'web_search',              source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'google_ai_search',        source: 'TOOL_REGISTRY · src/lib/ai-search-engines.ts' },
      { name: 'github_search',           source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'arxiv_search',            source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'free_apis_directory',     source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'page_reader',             source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'http_fetch',              source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'google_trends_fetch',     source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'producthunt_search',      source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'reddit_search',           source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'scout_trend_autopilot',   source: 'TOOL_REGISTRY · src/lib/tools.ts' },
    ],
  ...
  },
  {
    ...
    tools: [
      { name: 'multi_search_compare',   source: 'TOOL_REGISTRY · src/lib/multi-search-comparison.ts' },
      { name: 'google_ai_search',       source: 'TOOL_REGISTRY · src/lib/ai-search-engines.ts' },
      { name: 'perplexity_ai_search',  source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'web_search',             source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'page_reader',            source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'wikipedia_search',       source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'market_research_deep',   source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'market_trend_analysis',  source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'income_reality_check',    source: 'TOOL_REGISTRY · src/lib/tools.ts' },
    ],
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'web_search',             source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'page_reader',            source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'semantic_memory',        source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'memory_store',           source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'memory_recall',          source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'customer_survey_engine', source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'customer_feedback_collector', source: 'TOOL_REGISTRY · src/lib/tools.ts' },
    ],
  ...
  },
  {
    ...
    tools: [
      { name: 'business_model_designer',  source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'portfolio_optimizer',       source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'portfolio_performance_optimizer', source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'adaptive_pricing',          source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'income_reality_check',      source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'predictive_bi',             source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'web_search',                source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'multi_provider_compare',    source: 'TOOL_REGISTRY · src/lib/tools.ts' },
    ],
  ...
  },
  {
    ...
    tools: [
      { name: 'business_model_designer',  source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'adaptive_pricing',          source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'mission_tracker',          source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'affiliate_link_generator', source: 'TOOL_REGISTRY · src/lib/affiliate-link-generator.ts' },
      { name: 'product_hunt',            source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'service_delivery',         source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'web_search',              source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'page_reader',            source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'http_fetch',             source: 'TOOL_REGISTRY · src/lib/tools.ts' },
    ],
  ...
  },
  {
    ...
    tools: [
      { name: 'dataforseo',              source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'ahrefs_seo',              source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'google_analytics',         source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'affiliate_link_generator', source: 'TOOL_REGISTRY · src/lib/affiliate-link-generator.ts' },
      { name: 'email_marketing_automation_full', source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'hootsuite_schedule',      source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'automated_social_posting', source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'web_search',              source: 'TOOL_REGISTRY · src/lib/tools.ts' },
    ],
  ...
  },
  {
    ...
    tools: [
      { name: 'forge_automation_library', source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'auto_recovery_v2',         source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'autonomous_executor_v2',    source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'tool_self_healing_loop',   source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'continuous_optimization_engine', source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'calendar_schedule',        source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'automated_reporting_dashboard', source: 'TOOL_REGISTRY · src/lib/tools.ts' },
    ],
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'portfolio_performance_optimizer', source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'income_reality_check',    source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'financial_tracker',       source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'financial_controls',      source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'budget_forecaster',       source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'mission_tracker',         source: 'TOOL_REGISTRY · src/lib/tools.ts' },
    ],
...
export const CHIEF_VENTURE_SCIENTIST: ChiefVentureScientist = {
  ...
  tools: [
    { name: 'ab_test_runner',          source: 'TOOL_REGISTRY · src/lib/tools.ts' },
    { name: 'ab_test_optimizer',       source: 'TOOL_REGISTRY · src/lib/tools.ts' },
    { name: 'real_feedback_loop',      source: 'TOOL_REGISTRY · src/lib/tools.ts' },
    { name: 'feedback_optimization_loop', source: 'TOOL_REGISTRY · src/lib/tools.ts' },
    { name: 'accuracy_feedback_loop',  source: 'TOOL_REGISTRY · src/lib/tools.ts' },
    { name: 'decision_feedback_loop',  source: 'TOOL_REGISTRY · src/lib/tools.ts' },
    { name: 'continuous_optimization_engine', source: 'TOOL_REGISTRY · src/lib/tools.ts' },
    { name: 'knowledge_base_curator',  source: 'TOOL_REGISTRY · src/lib/tools.ts' },
  ],
...
export const VID_SPECIALISTS: VidSpecialist[] = [
  {
    ...
    tools: [
      { name: 'compliance_legal_manager', source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'financial_controls',    source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'audit_log_hardener',     source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'fraud_prevention',       source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'web_search',            source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'memory_store',           source: 'TOOL_REGISTRY · src/lib/tools.ts' },
    ],
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'audit_log_hardener',     source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'portfolio_optimizer',    source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'cost_guard',            source: 'TOOL_REGISTRY · src/lib/tools.ts' },
    ],
  ...
  },
  {
    ...
    tools: [
      { name: 'image_gen',             source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'canva_design',          source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'ai_content_factory',     source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'multi_format_generation', source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'content_qa',            source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'personalization_engine_v2', source: 'TOOL_REGISTRY · src/lib/tools.ts' },
    ],
  ...
  },
  {
    ...
    tools: [
      { name: 'forge_automation_library', source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'tool_self_healing_loop',   source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'auto_fix_common_issues',   source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'developer_code_quality_audit', source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'fix_verifier',           source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'db_migration_validator', source: 'TOOL_REGISTRY · src/lib/tools.ts' },
      { name: 'comprehensive_self_check', source: 'TOOL_REGISTRY · src/lib/tools.ts' },
    ],
