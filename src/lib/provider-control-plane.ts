...
export const PROVIDER_RUNTIME_CONFIG: Readonly<Record<ActiveProviderId, ProviderRuntimeConfig>> = {
  groq: { id: 'groq', label: 'Groq', baseUrl: 'https://api.groq.com/openai/v1/chat/completions', apiKeyEnv: 'GROQ_API_KEY', modelEnv: 'GROQ_MODEL', defaultModel: 'openai/gpt-oss-120b', modelsUrl: 'https://api.groq.com/openai/v1/models', preferredModels: ['openai/gpt-oss-120b', 'openai/gpt-oss-20b'], catalogMode: 'live-api', contextWindowTokens: 131_072, inputSafetyMarginTokens: 16_000 },
