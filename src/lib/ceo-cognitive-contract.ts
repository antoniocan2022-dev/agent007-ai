...
export interface QualityResult{decision:QualityDecision;evidenceState:EvidenceState;verificationStatus:VerificationStatus;checks:{nonEmpty:boolean;contractValid:boolean;objectiveCoverage:boolean;internalConsistency:boolean;evidenceDiscipline:boolean;actionableStructure:boolean};evidenceScope?:EvidenceScope;evidenceFreshness?:EvidenceFreshness;claimScopes?:EvidenceScope[];contextContinuity?:ContextContinuitySummary;conversationQuality?:ConversationQualitySummary;failureReason?:CeoFailureReason;failure?:unknown;reasons:string[]}
export interface CognitiveLifecycleResult{content:string;provider?:string;model?:string;responseMs:number;attempts:string[];executionPlan:ExecutionPlan;decisionPlan:DecisionPlan;quality:QualityResult;evidenceState:EvidenceState;degraded:boolean;failureReason?:CeoFailureReason}
