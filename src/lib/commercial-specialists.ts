...
export const COMMERCIAL_SPECIALISTS: readonly CommercialSpecialist[] = [
  ...
  { id: 'integration_engineer', title: 'Commercial Integration Engineer', division: 'Product & Engineering', reportsTo: 'forge', mission: 'Implement provider adapters with idempotency, auth, audit, and failure recovery.', businesses: ['revenue-recovery', 'operations-kit', 'career-command'] },
  { id: 'automation_engineer', title: 'Commercial Automation Engineer', division: 'Product & Engineering', reportsTo: 'forge', mission: 'Implement durable workflows, retries, schedules, and event-driven automation.', businesses: ['revenue-recovery', 'operations-kit', 'career-command'] },
