...
export type CeoContextModuleName = 'organization' | 'evidence' | 'mission' | 'memory' | 'execution' | 'conversation' | 'attachments' | 'conversation_state' | 'cognitive_context' | 'self_inspection'
