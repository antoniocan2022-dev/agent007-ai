...
export type CeoContextModuleName = 'organization' | 'evidence' | 'mission' | 'memory' | 'execution' | 'conversation' | 'attachments' | 'conversation_state' | 'cognitive_context'
...
export interface CeoContextModules { organization?: string; evidence?: string; mission?: string; memory?: string; execution?: string; attachments?: string }
export interface CeoContextModulePolicyInput { intent: string; missionRelevant: boolean; evidenceClass: string; taskClass?: string; executionRequirement: string; evidence?: string; mission?: string; memory?: string; execution?: string; attachments?: string }
