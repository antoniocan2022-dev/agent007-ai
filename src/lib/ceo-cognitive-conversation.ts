...
/**
 * Builds the objective used by external evidence acquisition. For an accepted continuation, the prior
 * objective is part of the evidence query itself; the current turn is appended as the new refinement.
 * This prevents a pronoun-heavy follow-up (for example, "those... each") from reaching the evidence
