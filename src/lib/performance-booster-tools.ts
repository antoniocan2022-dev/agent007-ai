...
export async function toolSmartToolRouter(args: any, _ctx: ToolContext): Promise<ToolResult> {
  ...
  const toolMap: Record<string, string[]> = {
    ...
    'crawl': ['firecrawl_scrape', 'firecrawl_map', 'firecrawl_crawl', 'spider_scrape', 'spider_crawl', 'jina_reader', 'page_reader'],
    ...
    'finance': ['yahoo_finance', 'coingecko', 'finnhub_quote', 'alpha_vantage', 'alpha_vantage_news', 'fred_economic', 'financial_tracker', 'tiingo_daily', 'polygon_aggregates', 'roic_stock_prices', 'roic_financials', 'polygon_corporate_actions'],
    'stock': ['yahoo_finance', 'finnhub_quote', 'alpha_vantage', 'alpha_vantage_news', 'tiingo_daily', 'polygon_aggregates', 'roic_stock_prices'],
    'ohlcv': ['tiingo_daily', 'polygon_aggregates', 'roic_stock_prices'],
    'corporate actions': ['polygon_corporate_actions', 'tiingo_daily'],
    'crypto': ['coingecko'],
