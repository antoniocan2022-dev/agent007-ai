...
export async function toolSmartToolRouter(args: any, _ctx: ToolContext): Promise<ToolResult> {
  ...
  const toolMap: Record<string, string[]> = {
    ...
    'finance': ['yahoo_finance', 'coingecko', 'finnhub_quote', 'alpha_vantage', 'alpha_vantage_news', 'fred_economic', 'financial_tracker', 'tiingo_daily', 'polygon_aggregates', 'roic_stock_prices'],
