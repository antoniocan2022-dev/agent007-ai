...
export const COMMERCIAL_LEADERS: readonly CommercialLeader[] = [
  ...
  { id: 'vertex', title: 'Product Leader', division: 'Product & Engineering', mission: 'Own product architecture, integration boundaries, and reusable commercial capabilities.', reportsTo: 'vid', directReports: ['integration_engineer', 'automation_engineer'], businesses: ['revenue-recovery', 'operations-kit', 'career-command'] },
  { id: 'forge', title: 'Engineering Leader', division: 'Product & Engineering', mission: 'Implement and harden production-ready commercial workflows under repository governance.', reportsTo: 'vertex', directReports: ['integration_engineer', 'automation_engineer'], businesses: ['revenue-recovery', 'operations-kit', 'career-command'] },
