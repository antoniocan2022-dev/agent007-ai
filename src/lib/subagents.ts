...
`,
  },
  {
    ...
    color: '#34d399',
    icon: 'Box',
    allowedTools: ['code_exec','web_search','website_builder','ui_form_builder','stripe_payment_processor','memory_store','memory_recall','decision_matrix','http_fetch','multi_provider_compare'],
    isBuiltin: true,
    enabled: true,
...
- Max 15 tool calls.`,
  },
  {
    ...
    color: '#fb923c',
    icon: 'Hammer',
    allowedTools: ['code_exec','file_write','file_read','web_search','website_builder','smart_retry_engine_v2','task_decomposer_v2','autonomous_executor_v2','result_verifier_v2','memory_store','memory_recall','parallel_executor','quality_scorer_v2','semantic_router_v2','tool_knowledge_base','http_fetch','tool_cache','multi_provider_compare'],
    isBuiltin: true,
    enabled: true,
...
TOOL CACHE: <tool name="tool_cache">{"action":"get","task":"<desc>"}</tool>`,
  },
  {
    ...
    color: '#f472b6',
    icon: 'PenLine',
    allowedTools: ['code_exec','web_search','grammarly_check','deepl_translate','yoast_seo','memory_store','memory_recall','parallel_executor','page_reader','multi_provider_compare'],
    isBuiltin: true,
    enabled: true,
...
- Max 15 tool calls.`,
  },
  {
    ...
    color: '#e879f9',
    icon: 'Palette',
    allowedTools: ['image_gen','pollinations_image','craiyon_image','stability_image','remove_bg','canva_design','memory_store','memory_recall','web_search','tool_priority_guide','multi_provider_compare'],
    isBuiltin: true,
    enabled: true,
...
TOOL CACHE: <tool name="tool_cache">{"action":"get","task":"<desc>"}</tool>`,
  },
  {
    ...
    color: '#22d3ee',
    icon: 'Scale',
    allowedTools: ['web_search','multi_search_compare','source_quality_ranker','jina_reader','content_verifier','memory_store','memory_recall','income_reality_check','page_reader','http_fetch','code_exec','multi_provider_compare'],
    isBuiltin: true,
    enabled: true,
...
- Max 15 tool calls.`,
  },
  {
    ...
    color: '#10b981',
    icon: 'Landmark',
    allowedTools: ['web_search','alpha_vantage','fred_economic','multi_search_compare','source_quality_ranker','memory_store','memory_recall','income_reality_check','page_reader','http_fetch','code_exec','multi_provider_compare'],
    isBuiltin: true,
    enabled: true,
...
- Max 15 tool calls.`,
   ...
   * ════════════════════════════════════════════════════════════════ */
  {
    ...
    color: '#fbbf24',
    icon: 'TrendingUp',
    allowedTools: ['alpha_vantage','yahoo_finance','fred_economic','web_search','code_exec','decision_matrix','memory_store','memory_recall','anomaly_detector','http_fetch','multi_provider_compare'],
    isBuiltin: true,
    enabled: true,
...
${SHARED_MAX_PERFORMANCE_PROTOCOL}`,
  },
  {
    ...
    color: '#ef4444',
    icon: 'ShieldAlert',
    allowedTools: ['http_fetch','web_search','security_health_checker','csp_diagnostic','code_exec','memory_store','memory_recall','page_reader','multi_provider_compare'],
    isBuiltin: true,
    enabled: true,
...
TOOL CACHE: <tool name="tool_cache">{"action":"get","task":"<desc>"}</tool>`,
  },
  {
    ...
    color: '#10b981',
    icon: 'Code',
    allowedTools: ['code_exec','file_write','file_read','tool_fixer','tool_recovery','tool_self_healing_loop','tool_registry_auditor','tool_health_checker','security_health_checker','memory_store','memory_recall','parallel_executor','semantic_router_v2','quality_scorer_v2','page_reader','memory_store','memory_recall','failure_learning','tool_cache','multi_provider_compare'],
    isBuiltin: true,
    enabled: true,
