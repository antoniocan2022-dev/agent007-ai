...
describe('Phase 5 portfolio intelligence',()=>{
 it('does not treat missing operating evidence as observed',()=>{const score=healthScore({business:'revenue-recovery',revenue:100,cost:40,customers:5,leads:null,conversions:null,automation:70,satisfaction:null,confidence:0,observedPeriods:1,source:'test',period:'2026-08-13'});expect(score).toBe(43)})
