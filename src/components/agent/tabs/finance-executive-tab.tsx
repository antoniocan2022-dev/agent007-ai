      ...
      <div className="grid xl:grid-cols-[1.25fr_.75fr] gap-4">
        <div className="rounded-2xl glass border border-cyan-400/15 p-4 sm:p-5 space-y-5">
          ...
          <div className="grid sm:grid-cols-2 gap-3 text-xs">
            ...
            <div className="rounded-xl border border-amber-400/15 bg-amber-400/[0.03] bg-amber-400/[0.03] p-3"><div className="text-amber-200 font-semibold">Does not count</div><p className="mt-1 text-[#7c89b5]">Agent-generated estimates, targets, forecasts and auto-parsed text.</p></div>
          </div>
        </div>
