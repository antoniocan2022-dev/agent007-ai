...
describe('mission autonomy supervisor', () => {
  test('defines capability requirements for every durable mission stage', () => {
    ...
    for (const stage of stages) expect(capabilityRequirementForStage(stage)).toBeDefined()
  ...
  test('supervisor uses durable mission persistence and bounded leader execution', () => {
