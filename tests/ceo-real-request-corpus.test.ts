...
const CASES = [
  ...
  { name: 'web research request', message: 'Research the latest competitors in the AI executive software market.', intent: 'research', owner: 'ceo_lifecycle', route: 'full', execution: 'one_tool', toolRequired: true, subagentsRequired: false, maxRecoveries: 1, path: 'full' },
