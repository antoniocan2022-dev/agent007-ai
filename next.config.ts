...
const nextConfig: NextConfig = {
  output: 'standalone',
  // Production builds must enforce the same TypeScript correctness gate as CI.
  // Keeping ignoreBuildErrors=false prevents broken code from shipping merely
  // because a deployment provider permits the build to continue.
  typescript: {
